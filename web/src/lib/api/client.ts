...
export class ApiClient extends BaseApiClient {
  ...
  createPlaylistFromFilter(
    body: api.PostPlaylistFilterBody,
  ...
  addItemsToPlaylist(
    id: string,
    body: api.AddItemsToPlaylistBody,
    options?: ExtraOptions,
  ) {
    return this.request(
  ...
  deletePlaylistItems(
    id: string,
    body: api.DeletePlaylistItemsBody,
    options?: ExtraOptions,
  ) {
    return this.request(
      `/api/v1/playlists/${id}/items`,
  ...
  getTaglistTracks(id: string, options?: ExtraOptions) {
    return this.request(
      `/api/v1/taglists/${id}/tracks`,
      "GET",
      api.GetTaglistTracks,
      z.undefined(),
      undefined,
      options,
    );
